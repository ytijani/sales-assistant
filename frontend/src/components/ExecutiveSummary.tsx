...
export function ExecutiveSummary({ question, result }: ExecutiveSummaryProps) {
  ...
  return (
    <div className="relative rounded-2xl border border-slate-200/80 bg-white p-6 sm:p-8 shadow-xs transition-all">
      {/* Card Header */}
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-100 pb-5">
        ...
        <div className="flex items-center gap-2">
          <div className="inline-flex items-center gap-1.5 rounded-full bg-emerald-50/80 px-2.5 py-1 text-xs font-semibold text-emerald-800 border border-emerald-200/60">
      ...
      {/* Query Title */}
      <div className="mt-5">
        <p className="text-[11px] font-bold uppercase tracking-wider text-slate-400">Inquiry</p>
      ...
      <div className="mt-5 rounded-2xl border border-emerald-100 bg-gradient-to-br from-emerald-50/70 via-teal-50/30 to-white p-5 sm:p-6 shadow-2xs">
        <p className="text-xs font-bold uppercase tracking-wider text-emerald-800 flex items-center gap-1.5 mb-2">
      ...
      {result.answer.findings.length > 0 && (
        <div className="mt-6">
          <h3 className="text-[11px] font-bold uppercase tracking-wider text-slate-400 mb-3">
            Key Findings & Grounded Points ({result.answer.findings.length})
          </h3>
        ...
        <div className="mt-6 rounded-2xl border border-slate-200/80 bg-slate-50/70 p-5">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h4 className="text-[11px] font-bold uppercase tracking-wider text-slate-700">
              Strategic Meaning & Business Impact
            </h4>
          </div>
